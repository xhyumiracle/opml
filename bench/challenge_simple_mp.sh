...
/usr/bin/time -v mlvm/mlvm --outputMode=1 --outputBenchmark --basedir=/tmp/cannon --program="$PROGRAM_PATH" --modelName="$MODEL_NAME" --model="$MODEL_PATH" --data="$DATA_PATH" --target=0 --nodeID 0 2>&1
